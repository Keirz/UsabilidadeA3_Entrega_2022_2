...
const ProfessorDetail = (props) => {
  const { professorNome, profesorSegNome, professorCPF, professorTitulo,
     professorTurma, professorModuloTurma } = props.location.state.professor;
  return (
    <div className="main">
